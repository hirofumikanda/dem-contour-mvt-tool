...
- [x] 6.1 `bin/make-contour-pmtiles.sh`実行後に`viewer`で開発サーバーを起動し、自作等高線とGSI最適化ベクトルタイルの両方が描画されることをブラウザで確認する
- [x] 6.2 スワイプハンドルの操作、および一方の地図のパン・ズームがもう一方に追従することをブラウザで確認する
- [x] 6.3 計曲線の太線強調と標高ラベル表示をブラウザで確認する
- [x] 6.4 リポジトリのREADMEに`viewer/`の使い方（前提条件、起動コマンド）を追記する
