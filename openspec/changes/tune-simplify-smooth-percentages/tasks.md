...
- [ ] 5.1 `tests/run_tests.sh`を実行し、デフォルト値変更後も既存テストスイート全体が回帰なく通ることを確認する
- [ ] 5.2 `bin/make-contour-pmtiles.sh`を最終デフォルト値でエンドツーエンド実行し、`build/contours.pmtiles`が生成されることを確認する
- [ ] 5.3 `viewer`で最終成果物と国土地理院最適化ベクトルタイルを改めてz11・z13・z7・z10でスワイプ比較し、1.2で書き出した差異が改善していることを確認する
